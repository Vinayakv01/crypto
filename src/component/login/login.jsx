...
const Login = ({ onClose }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://cryptoapi-mdxc.onrender.com/api/login', formData.toString(), {
        headers: {
              ...
              <div className="mb-4">
                <label className="block text-white">
                  ...
                  <input
                    ...
                    className="mt-1 text-black block w-full border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring focus:border-blue-500"
                  />
                </label>
              </div>
